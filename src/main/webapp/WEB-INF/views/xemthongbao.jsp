                ...
                <div class="col-lg-10">	
					<ul class="list-group col-md-11">
						  <li class="list-group-item">
						    <span class="badge">${thongBao.maTb }</span>
						    Mã thông báo
						  </li>
						 <li class="list-group-item">
						    <span class="badge">${thongBao.taiKhoan.tenTk }</span>
						    Tên tài khoản
						  </li>
						  <li class="list-group-item">
						    Hình ảnh
						    <img src="${pageContext.request.contextPath}/getUserImage/${thongBao.hinhAnh.maAnh }" />
							
						  </li>
						  <li class="list-group-item">
						    <span class="badge">${thongBao.tieuDeTb }</span>
						    Tiêu đề
						  </li>
						  <li class="list-group-item">
						    <span class="badge">${thongBao.noiDungTb }</span>
						    Nội dung
						  </li>
						  <li class="list-group-item">
						    <span class="badge">${thongBao.thoiGianTb }</span>
						    Thời gian viết
						  </li>
					</ul>
					<br>
					<h3><span class="label label-default"><a  href="${pageContext.request.contextPath}/quanlythongbao.html"> Quay lại</a></span></h3>
				   </div>          
