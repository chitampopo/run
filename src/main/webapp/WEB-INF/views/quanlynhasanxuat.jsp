        ...
        <div id="page-wrapper" >
            <div id="page-inner">
                ...
                <div class="row"><!-- phần hiển thị nội dung -->
				               <div class="col-md-12">
				               <p><a href="${pageContext.request.contextPath}/quanlyphanhe.html" class="btn btn-primary btn-lg" role="button">Quản lý phân hệ</a></p>
								<!-- Advanced Tables -->
								<div class="panel panel-default">
									<div class="panel-heading">Bảng liệt kê các nhà sản xuất trong hệ thống</div>
									<div class="panel-body">
										<div class="table-responsive">
											<table class="table table-striped table-bordered table-hover"
												...
												<tbody>
													<c:forEach items="${hangSxs}" var="list">
														<tr class="odd gradeX">
															<td><c:out value="${list.maHangSx}"></c:out></td>
															<td><c:out value="${list.tenHangSx}"></c:out></td>
															<td><c:out value="${list.ghiChuHsx}"></c:out></td>
															<td class="center">
				                                                <a class="glyphicon glyphicon-pencil" href="<c:url value="/edit_hangSx/${list.maHangSx}"/>"></a>
				                                                <a class="glyphicon glyphicon-remove-sign" href="<c:url value="/delete_hangSx/${list.maHangSx}"/>"></a>
				                                            </td>
														</tr>
													</c:forEach>
												</tbody>
								...
								<!--End Advanced Tables -->
								<p><a href="${pageContext.request.contextPath}/themnhasanxuat.html" class="btn btn-primary btn-lg" role="button">Thêm nhà sản xuất</a></p>
							</div>
