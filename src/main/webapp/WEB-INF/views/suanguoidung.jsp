        ...
        <div id="page-wrapper" >
            <div id="page-inner">
                ...
                <div class="row"><!-- phần hiển thị nội dung -->
					<div class="col-lg-6">
						<div class="logindiv2">
							<form:form role="form" action="/capnhatnguoidung" commandName="taikhoan" method="post">
								...
								<div class="form-group">
									...
									<form:select path="loaiTk.maLoaiTk" class="form-control" items="${listLoaiTk}" required="true" itemLabel="tenLoaiTk" itemValue="maLoaiTk"/>
										<p class="thongbao"></p>
								</div>
								<div class="form-group">
