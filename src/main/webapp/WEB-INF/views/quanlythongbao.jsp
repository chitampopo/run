...
font-size: 16px;"> &nbsp; <a href="#" class="btn btn-danger square-btn-adjust">Thông tin tài khoản</a><a href="${pageContext.request.contextPath}/dangxuat.html" class="btn btn-danger square-btn-adjust">Đăng xuất</a> </div>
				...
				<li class="text-center">
                    ...
                    <li>
                        <a  href="${pageContext.request.contextPath}/quanlynguoidung.html"><i class="glyphicon glyphicon-user fa-3x"></i> Quản lý người dùng</a>
						   ...
						   <li  >
                        <a class="active-menu"  href="${pageContext.request.contextPath}/quanlythongbao.html"><i class="fa fa-bell-o fa-3x"></i> Quản lý thông báo</a>
                    </li>
                    <li>
        ...
        <div id="page-wrapper" >
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                     <h2>Trang quản trị bình luận</h2>   
                        <h5>Chào Quản trị!</h5>
                    </div>
                </div>              
                 <!-- /. ROW  -->
                ...
                <div class="row"><!-- phần hiển thị nội dung -->
				               <div class="col-md-12">
											...
											<table class="table table-striped table-bordered table-hover"
												...
												<tbody>
													<c:forEach items="${thongBaos}" var="thongBaos">
														<tr class="odd gradeX">
															<td>
																<c:out value="${thongBaos.maTb}"></c:out>
															</td>
															<td>
																<c:out value="${thongBaos.taiKhoan.tenTk}"></c:out>
															</td>
															<td>
																<c:out value="${thongBaos.hinhAnh.maAnh}"></c:out>
															</td>
															<td>
																<c:out value="${thongBaos.tieuDeTb}"></c:out>
															</td>
															<td>
																<c:out value="${thongBaos.noiDungTb}"></c:out>
															</td>
															<td>
																<c:out value="${thongBaos.thoiGianTb}"></c:out>
															</td>
															<td class="center">
				                                                <a class="glyphicon glyphicon-list-alt" href="<c:url value="/view_thongbao/${thongBaos.maTb}"/>"></a>
				                                                <a class="glyphicon glyphicon-remove-sign" href="<c:url value="/delete_thongbao/${thongBaos.maTb}"/>"></a>
				                                            </td>
														</tr>
													</c:forEach>
												</tbody>
								...
								<!--End Advanced Tables -->
								<p><a href="${pageContext.request.contextPath}/tranguploadHinhAnhThongBao.html" class="btn btn-primary btn-lg" role="button">Thêm thông báo</a></p>
							</div>
