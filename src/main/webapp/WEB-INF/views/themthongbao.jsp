        ...
        <div id="page-wrapper" >
            <div id="page-inner">
                ...
                <div class="row"><!-- phần hiển thị nội dung -->
					<div class="col-lg-6">
						<div class="logindiv2">
							<form:form role="form" action="themthongbao.do" commandName="thongBao" method="post" enctype="multipart/form-data">
								<div class="form-group">
									<label><!-- Mã thông báo --></label>
									<form:input type="hidden" class="form-control" path="maTb"
										placeholder="Mã thông báo"/>
										<p class="thongbao"></p>
								</div>
								<div class="form-group">
									<label>Tiêu đề</label>
									<form:input type="text" class="form-control" path="tieuDeTb"/>
										<p class="thongbao"></p>
								</div>
								<div class="form-group">
									<label>Nội dung thông báo</label>
									<form:input type="text" class="form-control" path="noiDungTb"
										placeholder="Nội dung thông báo"/>
										<p class="thongbao"></p>
								</div>
								<div class="form-group">
									<form:input type="hidden" class="form-control" path="thoiGianTb"/>
										<p class="thongbao" ></p>
								</div>
