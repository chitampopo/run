                ...
                <div class="row"><!-- phần hiển thị nội dung -->
				               <div class="col-md-12">
								...
								<div class="panel panel-default">
									<div class="panel-heading">Bảng liệt kê các bình luận trong
										hệ thống</div>
									<div class="panel-body">
										<div class="table-responsive">
											<table class="table table-striped table-bordered table-hover"
												...
												<tbody>
													<c:forEach items="${list_tai_khoan}" var="list_tai_khoan">
														<tr class="odd gradeX">
															<td><c:out value="${list_tai_khoan.maTk}"></c:out></td>
															<td>
																
																<c:choose>
																    <c:when test="${list_tai_khoan.loaiTk.getMaLoaiTk() == '1'}">
																        <c:out value="Quản Trị"></c:out>
																    </c:when>
																    <c:when test="${list_tai_khoan.loaiTk.getMaLoaiTk() == '2'}">
															...
															<td><c:out value="${list_tai_khoan.tenTk}"></c:out></td>
															<td>
																<c:choose>
																    <c:when test="${list_tai_khoan.gioiTinh == '1'}">
															...
															<td><c:out value="${list_tai_khoan.email}"></c:out></td>
															<td><c:out value="${list_tai_khoan.diaChi}"></c:out></td>
															<td><c:out value="${list_tai_khoan.namSinh}"></c:out></td>
															<td class="center">
																<a class="glyphicon glyphicon-list-alt" href="<c:url value="/view_taikhoan/${list_tai_khoan.maTk}"/>"></a>
				                                                <a class="glyphicon glyphicon-pencil" href="<c:url value="/edit_taikhoan/${list_tai_khoan.maTk}"/>"></a>
				                                                <a class="glyphicon glyphicon-remove-sign" href="<c:url value="/delete_taikhoan/${list_tai_khoan.maTk}"/>"></a>
				                                            </td>
														</tr>
													</c:forEach>
												</tbody>
								...
								<!--End Advanced Tables -->
								<p><a href="${pageContext.request.contextPath}/add_taikhoan.html" class="btn btn-primary btn-lg" role="button">Thêm người dùng</a></p>
							</div>
