        ...
        <div id="page-wrapper" >
            <div id="page-inner">
                ...
                <div class="row"><!-- phần hiển thị nội dung -->
				    <div class="col-md-12">
				    <a href="${pageContext.request.contextPath}/themHinhAnhDt.html" class="btn btn-primary btn-lg" role="button">Upload hình ảnh</a><br>
					<c:forEach items="${list}" var="p">
						<img src="${pageContext.request.contextPath}/getUserImage/${p}"/><br>
						<a class="glyphicon glyphicon-remove-sign" href="<c:url value="/delete_hinhAnh/${p}"/>">Xoá hình ảnh</a><br>	
					</c:forEach>
