        ...
        <div id="page-wrapper" >
            <div id="page-inner">
                ...
                <div class="row"><!-- phần hiển thị nội dung -->
					<div class="col-lg-6">
						<div class="logindiv2">
							<form:form role="form" action="/themHangSx" commandName="hangSx" method="post">
								<div class="form-group">
									<!--<label> Mã tài khoản </label>-->
									<form:input type="hidden" class="form-control" path="maHangSx"/>
								</div>
								<div class="form-group">
									<label>Tên hãng sản xuất</label>
									<form:input type="text" class="form-control" path="tenHangSx"/>
									<p class="thongbao"></p>
								</div>
								<div class="form-group">
									<label>Ghi chú</label>
									<form:input type="text" class="form-control" path="ghiChuHsx"/>
									<p class="thongbao"></p>
								</div>
