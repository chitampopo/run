                ...
                <div class="row"><!-- phần hiển thị nội dung -->
				               <div class="col-md-12">
								...
								<div class="panel panel-default">
									<div class="panel-heading">Bảng liệt kê các đơn giá của điện thoại <br><br>
									</div>
									<div class="panel-body">
										<div class="table-responsive">
											<table class="table table-striped table-bordered table-hover"
												...
												<tbody>
													<c:forEach items="${donGias}" var="donGias">
														<tr class="odd gradeX">
															<td><c:out value="${donGias.maGia}"></c:out></td>
															<td><c:out value="${donGias.gia}"></c:out></td>
															<td><c:out value="${donGias.giaKm}"></c:out></td>
															<td><c:out value="${donGias.donVi}"></c:out></td>
															<td><c:out value="${donGias.tgTaoGia}"></c:out></td>
													</c:forEach>
												</tbody>
											</table>
										</div>
							...
							<div class="col-lg-6">
						<div class="logindiv2">
							<form:form role="form" action="/themDonGia" commandName="donGia" method="post">
								<div class="form-group">
									<!--<label> Mã tài khoản </label>-->
									<form:input type="hidden" class="form-control" path="maGia"/>
									<form:input type="hidden" class="form-control" path="dienThoai.maDt" value="${maDt}"/>
								</div>
								<div class="form-group">
									<label>Giá</label>
								...
								<div class="form-group">
									...
									<form:input type="number" class="form-control" path="giaKm"/>
									<p class="thongbao"></p>
								</div>
								<div class="form-group">
									<label>Đơn vị tính</label>
									<form:input type="text" class="form-control" path="donVi"/>
									<p class="thongbao"></p>
								</div>
								<div class="form-group">
									<form:input type="hidden" class="form-control" path="tgTaoGia"/>
									<p class="thongbao"></p>
								</div>
