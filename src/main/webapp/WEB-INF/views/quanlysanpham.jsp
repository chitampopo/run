                ...
                <div class="row"><!-- phần hiển thị nội dung -->
				               <div class="col-md-12">
								...
								<div class="panel panel-default">
									<div class="panel-heading">Bảng liệt kê các sản phẩm trong hệ thống<br><br>
										<a href="${pageContext.request.contextPath}/themsanpham.html" class="btn btn-primary btn-lg" role="button">Thêm sản phẩm</a>
									</div>
									<div class="panel-body">
										<div class="table-responsive">
											<table class="table table-striped table-bordered table-hover"
												...
												<tbody>
													<c:forEach items="${list_san_pham}" var="list_san_pham">
														<tr class="odd gradeX">
															<td><c:out value="${list_san_pham.maDt}"></c:out></td>
															<td><c:out value="${list_san_pham.tenDt}"></c:out></td>
															<td><c:out value="${list_san_pham.ghiChuDt}"></c:out></td>
															<td><c:out value="${list_san_pham.phuKien}"></c:out></td>
															<td><c:out value="${list_san_pham.slConLai}"></c:out></td>
															<td class="center">
				                                                <a data-toggle="tooltip" data-placement="left" title="Chỉnh sửa thông tin điện thoại" class="glyphicon glyphicon-pencil" href="<c:url value="/edit_dienThoai/${list_san_pham.maDt}"/>"></a>
				                                                <a data-toggle="tooltip" data-placement="left" title="Xóa điện thoại" class="glyphicon glyphicon-remove-sign" href="<c:url value="/delete_dienThoai/${list_san_pham.maDt}"/>"></a>
				                                                <a data-toggle="tooltip" data-placement="left" title="Cập nhật hình ảnh điện thoại" class="glyphicon glyphicon-picture" href="<c:url value="/update_hinhAnhDienThoai/${list_san_pham.maDt}"/>"></a>
				                                                <a data-toggle="tooltip" data-placement="left" title="Cập nhật giá điện thoại" class="glyphicon glyphicon-list-alt" href="<c:url value="/update_donGiaDienThoai/${list_san_pham.maDt}"/>"></a>
				                                                <a data-toggle="tooltip" data-placement="left" title="Cập nhật bình luận của điện thoại" class="glyphicon glyphicon-pencil" href="<c:url value="/update_binhLuanDienThoai/${list_san_pham.maDt}"/>"></a>
				                                                <a data-toggle="tooltip" data-placement="left" title="Cập nhật các bài đánh giá về điện thoại" class="glyphicon glyphicon-book" href="<c:url value="/update_danhGiaDienThoai/${list_san_pham.maDt}"/>"></a>
				                                            </td>
														</tr>
													</c:forEach>
