           ...
           <!-- /. NAV TOP  -->
            ...
            <div class="sidebar-collapse">
				...
				<li class="text-center">
                    ...
                    <li>
                        <a class="active-menu"  href="${pageContext.request.contextPath}/quanlybinhluan.html"><i class="glyphicon glyphicon-comment fa-3x"></i> Quản lý bình luận</a>
                    </li>
                    <li>
									...
									<div class="panel-body">
										<div class="table-responsive">
											<table class="table table-striped table-bordered table-hover"
												...
												<tbody>
													<c:forEach items="${lsBinhLuan}" var="lsBinhLuan">
														<tr class="odd gradeX">
															<td>
																<c:out value="${lsBinhLuan.maBl}"></c:out>
															</td>
															<td>
																<c:out value="${lsBinhLuan.taiKhoan.tenTk}"></c:out>
															</td>
															<td>
																<c:out value="${lsBinhLuan.thoiGianBl}"></c:out>
															</td>
															<td>
																<c:out value="${lsBinhLuan.noiDungBl}"></c:out>
															</td>
															<td>
																<c:out value="${lsBinhLuan.baoViPham}"></c:out>
															</td>
															<td class="center">
				                                                <a class="glyphicon glyphicon-remove-sign" href="xoabinhluan.do?mabl=${lsBinhLuan.maBl}"></a>
				                                            </td>
														</tr>
													</c:forEach>
												</tbody>
