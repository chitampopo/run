				...
				<div class="main span12">
					<div class="col-main">
						<div class="std">
							...
							<div class="main span12">
								<link rel="stylesheet" type="text/css"
									href="http://www.dev-mdl.in/metroshop/skin/frontend/default/metrostore/css/banner2.css"
									media="all" />
								<link rel="stylesheet" type="text/css"
									href="http://www.dev-mdl.in/metroshop/skin/frontend/default/metrostore/css/custom.css"
									media="all" />
								<script type="text/javascript"
									src="http://www.dev-mdl.in/metroshop/skin/frontend/default/metrostore/js/custom.js"></script>
								<script type="text/javascript">
									jQuery(document)
											.ready(
													function() {
								...
								<!-- Slider -->
								<div class="span12 bannerRow">
									<div class="metro-banner-wrapper max-box box-level-3">
										<div id="metro-banner" class="metro-banner">
											<div class="metro-banner-inner">
												<div class="metro-banner-inSide">
													<a class="metro-banner-slide block-3 bg-color-slider"
														href="#"> <span class="imgBox box-level-2 marginNone">
															<img class="slider_img"
															src="${pageContext.request.contextPath}/resources/mytheme/images/metro1.jpg"
															title="Banner 1" alt="Banner 1" />
													</span>
														<div class="metorDis" style="display: none;">
															<h2>Banner 1</h2>
															<p>Chú thích banner</p>
														</div>
													</a> <a class="metro-banner-slide block-3 bg-color-slider"
														href="#"> <span class="imgBox box-level-2 marginNone">
															<img class="slider_img"
															src="${pageContext.request.contextPath}/resources/mytheme/images/metro2.jpg"
															title="Banner 2" alt="Banner 2" />
													</span>
														<div class="metorDis" style="display: none;">
															<h2>Banner 2</h2>
															<p>Chú thích 2</p>
														...
														href="#"> <span class="imgBox box-level-2 marginNone">
															<img class="slider_img"
															src="${pageContext.request.contextPath}/resources/mytheme/images/metro3.jpg"
															title="Banner 3" alt="Banner 3" />
													</span>
														<div class="metorDis" style="display: none;">
															<h2>Banner 3</h2>
															<p>Chú thích banner 3</p>
														</div>
													</a> <a class="metro-banner-slide block-3 bg-color-slider"
														href="#"> <span class="imgBox box-level-2 marginNone">
															<img class="slider_img"
															src="${pageContext.request.contextPath}/resources/mytheme/images/metro4.jpg"
															title="Banner 4" alt="Banner 4" />
													</span>
														<div class="metorDis" style="display: none;">
															<h2>Banner 4</h2>
															<p>Chú thích banner 4</p>
														</div>
													</a>
												</div>
											</div>
									...
									<!--Pháº§n kÃ©o áº£nh banner -->
									<div class="clear anti-mar sepB">&nbsp;</div>
									<div
										class="metro-banner-control max-box block-h-half bg-color-slider"
										id="metro-banner-control">
										<a href="#" class="control-left"></a>
										<div class="control-seek">
											<div class="control-seek-box">
												<div class="control-seek-box-inner"></div>
											</div>
										</div>
								...
								<link rel="stylesheet" type="text/css"
									...
									media="all" />
								<script type="text/javascript"
									src="${pageContext.request.contextPath}/resources/mytheme/js/light_box.js"></script>
								<script type="text/javascript"
									src="${pageContext.request.contextPath}/resources/mytheme/js/ajax_cart.js"></script>
							</div>
							...
							<div class="col2-left-layout span12">
								<div class="col-main span9 sideCol-right">
									...
									<div class="slider-box">
										<div class="headingBox">
											...
											<h1 class="line_heading">Sản phẩm bán chạy</h1>
										</div>
										<div class="loadBox">
											<img
												src="${pageContext.request.contextPath}/resources/mytheme/images/loading.gif" />
										</div>
										<div id="mix_container" class="mix_container bestsellerBox"
											style="display: none;">
											<div class="mix_wrapper">
												<div class="mix_inner">
													<ul class="bestseller">
														<li class="item">
															<div class="itemInner">
																<a href="#" class="product-image"> <img
																	src="${pageContext.request.contextPath}/resources/mytheme/images/sanpham.jpg" />
																	<img class="hoverImg"
																	src="${pageContext.request.contextPath}/resources/mytheme/images/sanpham.jpg"
																	border="0" />
																</a>
																<div class="ic_caption">
																	...
																	<div class="price-box">
																		<span class="regular-price"
																			id="product-price-177-right"> <span
																			class="price">Giá</span>
																		</span>
																	</div>
																	<div class="bottomBox">
																		<div class="buttonox">
																			<button type="button" title="Thên vào giỏ hàng"
																		...
																		<div class="addBox">
																			<a href="#" title="So sánh" rel="tooltip"
																				data-placement="top" class="link-compare">So
																				sánh</a>
																		</div>
																	</div>
																</div>
														...
														<li class="item">
															<div class="itemInner">
																<a href="${pageContext.request.contextPath}/chitietdienthoai/${maDt}" class="product-image"> 
																<img src="${pageContext.request.contextPath}/getUserImage/${maHinhAnh1}" />
																<img class="hoverImg" src="${pageContext.request.contextPath}/getUserImage/${maHinhAnh2}"
																	border="0" />
																</a>
																<div class="ic_caption">
																	<h2 class="product-name">
																		<a href="#">${tenDienThoai }</a>
																	</h2>
																	<div class="price-box">
																		<span class="regular-price"
																			id="product-price-177-right"> <span
																			class="price">${giaDienThoai } ${donViTinh }</span>
																		</span>
																	</div>
																	<div class="bottomBox">
																		<div class="buttonox">
																			<button type="button" title="Thêm vào giỏ hàng"
																				class="button btn-cart"
																				onclick="setLocation('http://www.dev-mdl.in/metroshop/index.php/checkout/cart/add/uenc/aHR0cDovL3d3dy5kZXYtbWRsLmluL21ldHJvc2hvcC9pbmRleC5waHAvaG9tZS8_X19fc3RvcmU9ZGVmYXVsdA,,/product/177/')">
																				<span><span>Thên vào giỏ hàng</span></span>
																			</button>
																		</div>
																		<div class="addBox">
																			<a href="#" title="So sánh" rel="tooltip"
												...
												<div class="sliderNab">
													<a id="prev5" class="jcarousel-prev" href="#">&lt;</a> <a
														id="next5" class="jcarousel-next" href="#">&gt;</a>
												</div>
											</div>
										</div>
										<script type="text/javascript">
										...
										<script type="text/javascript"
											src="${pageContext.request.contextPath}/resources/mythemejs/jquery.carouFredSel-6.1.0-packed.js"></script>
										<script type="text/javascript"
											src="${pageContext.request.contextPath}/resources/mythemejs/jquery.touchSwipe.min.js"></script>
									</div>
									<div class="slider-box">
										<div class="headingBox">
											<span class="headingIcons newProductsIcon"></span>
											<h1 class="line_heading">Sản phẩm mới</h1>
											<a class="viewAll"
								...
								<div class="sidebar span3 sideColBar-right">
									...
									<div class="leftBanner block-banner block">
										<div class="slider">
											<div class="flexsliderSide">
												<ul class="slides">
													<c:forEach items="${thongBaos }" var="thongBaos">
														<li>
															<h2>Thông tin khuyến mãi</h2>
															<p>${thongBaos.tieuDeTb }</p> 
															<a href="#"> 
															<img src="${pageContext.request.contextPath}/getUserImage/${thongBaos.hinhAnh.maAnh }" alt="" />
															</a>
														</li>
													</c:forEach>
												</ul>
