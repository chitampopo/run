        ...
        <div id="page-wrapper" >
            <div id="page-inner">
                ...
                <div class="row"><!-- phần hiển thị nội dung -->
					<div class="col-lg-6">
						<div class="logindiv2">
							<form:form role="form" action="/luuPhanHe" commandName="phanHeDt" method="post">
								<div class="form-group">
									<!--<label> Mã tài khoản </label>-->
									<form:input type="hidden" class="form-control" path="maPhanHe"/>
								</div>
								<div class="form-group">
									<label>Tên hãng sản xuất</label>
									<form:select class="form-control" path="hangSx.maHangSx" items="${hangSxs}" required="true" itemLabel="tenHangSx" itemValue="maHangSx"/>
									<p class="thongbao"></p>
								</div>
								<div class="form-group">
									<label>Tên phân hệ</label>
									<form:input type="text" class="form-control" path="tenPhanHe"/>
									<p class="thongbao"></p>
								</div>
								<div class="form-group">
									<label>Ghi chú</label>
									<form:input type="text" class="form-control" path="ghiChuPh"/>
									<p class="thongbao"></p>
								</div>
